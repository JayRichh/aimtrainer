...
const SceneSetup: React.FC<SceneSetupProps> = React.memo(({ 
  ...
  useHelper(directionalLightRef as React.MutableRefObject<THREE.DirectionalLight>, THREE.DirectionalLightHelper, 5)
  ...
  return (
    <>
      ...
      {weatherCondition === 'cloudy' && (
        <fog attach="fog" args={['#c1c1c1', 0, 100]} />
      )}
